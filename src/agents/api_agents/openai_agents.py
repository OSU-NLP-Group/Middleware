...
class OpenAIChatCompletion(Agent):
    ...
    @backoff.on_exception(backoff.expo, (RateLimitError, openai.error.Timeout, APIError, APIConnectionError, ServiceUnavailableError, openai.error.InvalidRequestError),
                      max_tries=10)
